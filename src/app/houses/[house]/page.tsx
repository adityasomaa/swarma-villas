...
export default async function HousePage({
  ...
  const canonicalPath = `/houses/${house.slug}`;
            ...
            <Reveal delay={100}>
              ...
              >
                ...
                <dl className="mt-7 space-y-4 border-t border-line pt-6">
                  <Spec label="Bed" value={house.bed} />
                  <Spec label="Sleeps" value={`Up to ${house.maxGuests} guests`} />
                  <Spec label="Floor area" value={`${house.sizeSqm} sqm`} />
